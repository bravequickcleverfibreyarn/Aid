...
[assembly: SuppressMessage ("Style", "IDE0022:Use expression body for methods", Justification = "No room.", Scope = "member", Target = "~M:Software9119.Aid.Enumerable.Unchecked.EnumerableExtensions.ToDictionary``2(System.Collections.Generic.IEnumerable{``1},System.Func{``1,``0},System.Int32)~System.Collections.Generic.Dictionary{``0,``1}")]
...
[assembly: SuppressMessage ("Style", "IDE0046:Convert to conditional expression", Justification = "Fine.", Scope = "member", Target = "~M:Software9119.Aid.Enumerable.EnumerableExtensions.ToArray``1(System.Collections.Generic.IEnumerable{``0},System.Int32,System.Boolean)~``0[]")]
...
[assembly: SuppressMessage ("Naming", "CA1715:Identifiers should have correct prefix", Justification = "Fine.", Scope = "type", Target = "~T:Software9119.Aid.Collection.CollectionExtensions")]
[assembly: SuppressMessage ("Naming", "CA1715:Identifiers should have correct prefix", Justification = "Fine.", Scope = "type", Target = "~T:Software9119.Aid.Object.ObjectAide")]
[assembly: SuppressMessage ("Naming", "CA1715:Identifiers should have correct prefix", Justification = "Fine.", Scope = "type", Target = "~T:Software9119.Aid.Enumerable.Unchecked.EnumerableExtensions")]
[assembly: SuppressMessage ("Naming", "CA1715:Identifiers should have correct prefix", Justification = "Fine.", Scope = "type", Target = "~T:Software9119.Aid.Enumerable.EnumerableExtensions")]
...
#region Design
[assembly: SuppressMessage ("Design", "CA1002:Do not expose generic lists", Justification = "Intentional.", Scope = "member", Target = "~M:Software9119.Aid.Enumerable.Unchecked.EnumerableExtensions.ToList``1(System.Collections.Generic.IEnumerable{``0},System.Int32)~System.Collections.Generic.List{``0}")]
[assembly: SuppressMessage ("Design", "CA1002:Do not expose generic lists", Justification = "Intentional.", Scope = "member", Target = "~M:Software9119.Aid.Enumerable.EnumerableExtensions.ToList``1(System.Collections.Generic.IEnumerable{``0},System.Int32,System.Boolean)~System.Collections.Generic.List{``0}")]
...
[assembly: SuppressMessage ("Design", "CA1062:Validate arguments of public methods", Justification = "Fine.", Scope = "member", Target = "~M:Software9119.Aid.Enumerable.Unchecked.EnumerableExtensions.ToArray``1(System.Collections.Generic.IEnumerable{``0},System.Int32)~``0[]")]
[assembly: SuppressMessage ("Design", "CA1062:Validate arguments of public methods", Justification = "Fine.", Scope = "member", Target = "~M:Software9119.Aid.Enumerable.Unchecked.EnumerableExtensions.ToList``1(System.Collections.Generic.IEnumerable{``0},System.Int32)~System.Collections.Generic.List{``0}")]
[assembly: SuppressMessage ("Design", "CA1062:Validate arguments of public methods", Justification = "Fine.", Scope = "member", Target = "~M:Software9119.Aid.Enumerable.Unchecked.EnumerableExtensions.ToDictionary``3(System.Collections.Generic.IEnumerable{``2},System.Func{``2,``0},System.Func{``2,``1},System.Int32)~System.Collections.Generic.Dictionary{``0,``1}")]
