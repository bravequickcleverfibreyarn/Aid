...
public struct Step : IEquatable<Step>
{
  ...
  override public bool Equals ( object obj ) => obj is Step step && Equals (step);
  ...
  override public int GetHashCode () => $"{Size}{value}".GetHashCode (StringComparison.InvariantCultureIgnoreCase);
