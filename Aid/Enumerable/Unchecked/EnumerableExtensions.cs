...
namespace Software9119.Aid.Enumerable.Unchecked;

/// <summary>
/// Core functionality for <see cref="Enumerable.EnumerableExtensions"/> without parameter checks.
/// </summary>
static public class EnumerableExtensions
{
  ...
  {
    return iEnumerable.ToDictionary (keySelector, value => value, count);
  }
